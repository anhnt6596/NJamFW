...
public static class DoTweenUtils
{
    ...
    public static void UpdateNumber(TextMeshProUGUI nodeText, long oldValue, long newValue, Func<long, string> transform, float actionTime = 1)
    {
    ...
    public static void UpdateNumber(TextMeshProUGUI nodeText, long oldValue, long newValue, float actionTime = 1)
    {
        UpdateNumber(nodeText, oldValue, newValue, x => x.ToString(), actionTime);
    }
}